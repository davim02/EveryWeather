...
void SensorWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->edit((*reinterpret_cast< std::add_pointer_t<const Sensor*>>(_a[1]))); break;
        case 1: _t->remove((*reinterpret_cast< std::add_pointer_t<uint>>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (SensorWidget::*)(const Sensor * );
            if (_t _q_method = &SensorWidget::edit; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (SensorWidget::*)(const unsigned int );
            if (_t _q_method = &SensorWidget::remove; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void SensorWidget::edit(const Sensor * _t1)
{
...
// SIGNAL 1
void SensorWidget::remove(const unsigned int _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
